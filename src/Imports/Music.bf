...
namespace BeefBass
{
    extension Bass
    {
        ...
        public static int32 MusicLoad(StringView File, int64 Offset = 0, int32 Length = 0, BassFlags Flags = BassFlags.Default, int32 Frequency = 0)
        {
            return BASS_MusicLoad(false, File.ToScopedNativeWChar!(), Offset, Length, Flags | BassFlags.Unicode, Frequency);
        }
        ...
        /// <exception cref="Errors.No3D">Could not initialize 3D support.</exception>
        /// <exception cref="Errors.Unknown">Some other mystery problem!</exception>
        public static int32 MusicLoad(void* Memory, int Offset, int32 Length, BassFlags Flags = BassFlags.Default, int32 Frequency = 0)
        {
            return BASS_MusicLoad(true, (void*)((int)Memory + Offset), 0, Length, Flags, Frequency);
        }

        /// <summary>
        /// Loads a MOD music file - MO3 / IT / XM / S3M / MTM / MOD / UMX formats from memory.
        /// </summary>
        /// <param name="Memory">uint8[] containing the music data.</param>
        /// <param name="Offset">Memory offset to load the MOD music from.</param>
        /// <param name="Length">Data length.</param>
        /// <param name="Flags">A combination of <see cref="BassFlags"/>.</param>
        /// <param name="Frequency">Sample rate to render/play the MOD music at... 0 = the rate specified in the <see cref="Init" /> call.</param>
        ...
        /// <exception cref="Errors.No3D">Could not initialize 3D support.</exception>
        /// <exception cref="Errors.Unknown">Some other mystery problem!</exception>
        public static int32 MusicLoad(uint8[] Memory, int Offset, int32 Length, BassFlags Flags = BassFlags.Default, int32 Frequency = 0)
        {
            return MusicLoad(Memory.Ptr, Offset, Length, Flags);
        }
    }
}
