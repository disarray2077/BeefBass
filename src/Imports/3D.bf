...
namespace BeefBass
{
    extension Bass
    {
        ...
        /// On other platforms, only the <see cref="BeefBass.Algorithm3D.Default"/> and <see cref="BeefBass.Algorithm3D.Off"/> options are available.
        /// </para>
        /// </remarks>
        public static Algorithm3D Algorithm3D
        {
            get => (Algorithm3D)GetConfig(Configuration.Algorithm3D);
            set => Configure(Configuration.Algorithm3D, (int32)value);
        }
